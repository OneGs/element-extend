    ...
    <component
      ...
      <component
        ...
        :style="
          ready
            ? {
                transform: `translate${direction === 'vertical' ? 'Y' : 'X'}(${view.position}px) translate${
...
export default {
  ...
  mounted() {
    this.getScrollWrapper().addEventListener("scroll", this.handleScroll, { passive: true });
  ...
  methods: {
    /** get scroll wrap that scroll container */
    getScrollWrapper() {
      return this.$refs.scrollbar.wrap;
    },

    /** add view to pool that will be rendered in item */
    ...
    /** remove view from poll when outside the range */
    ...
    /** update item when visible change  */
    ...
    /** the core. calculate position and add or remove view to pool */
    ...
    /** get scroll wrap position */
    getScroll() {
      const { direction } = this;
      const el = this.getScrollWrapper();
    ...
    scrollToPosition(position) {
      ...
      viewport = this.getScrollWrapper();
      scrollDirection = direction.scroll;
      scrollDistance = position;

      console.log(viewport, scrollDistance);
